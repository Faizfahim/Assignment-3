      ...
      <section className="font-serif">
        <div className="flex w-full bg-red-800">
          <div className="ml-20 mt-40 mb-10 text-white text-4xl font-bold w-6/12 ">
            ...
            <div className="text-lg mt-8 px-4 py-3 border w-max rounded-full hover:bg-white hover:text-red-900 transition-all">
              <h1>Email : <a href="mailto: info@gmail.com">info@gmail.com</a></h1>
              
            </div>
            <div className="text-lg mt-4 px-4 py-3 border w-max rounded-full  hover:bg-white hover:text-red-900 transition-all">
              <h1>Phone :<a href="tel: +923643641974">+923643641974</a></h1>
          ...
          <div className="w-6/12 h-screen mt-40 -ml-40">
            <form className="flex justify-center">
              <fieldset>
                ...
                <button
                  type="submit"
                  className="text-white border rounded-full px-6 py-3 mt-4 text-lg hover:bg-white hover:text-red-800 transition-all"
                >
                  Send Message
                </button>
              </fieldset>
